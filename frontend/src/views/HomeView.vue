  ...
  <div class="space-y-8">
    ...
    <section class="bg-gradient-to-r from-blue-600 to-blue-800 text-white rounded-lg p-8">
      <div class="max-w-4xl mx-auto text-center">
        <h1 class="text-4xl font-bold mb-4">ACME Corporate Social Responsibility</h1>
        <p class="text-xl mb-6">
          Together, we make a difference in our community through meaningful charitable initiatives.
        </p>
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          <router-link to="/campaigns" class="btn-primary bg-white text-blue-600 hover:bg-gray-100">
            Browse Campaigns
          </router-link>
          <router-link
    ...
    <section v-if="campaignsStore.featuredCampaigns.length > 0">
      <div class="flex items-center justify-between mb-6">
        ...
        <router-link to="/campaigns" class="text-blue-600 hover:text-blue-800 font-medium">
          View all →
        </router-link>
      </div>
    ...
    <section v-if="!authStore.isAuthenticated" class="text-center bg-blue-50 rounded-lg p-8">
      <h2 class="text-2xl font-bold text-gray-900 mb-4">Ready to Make a Difference?</h2>
      <p class="text-gray-600 mb-6">
        Join your colleagues in supporting meaningful causes and making a positive impact in our
        community.
      </p>
